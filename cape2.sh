#!/bin/bash
# By @xzwl233 - https://twitter.com/D00m3dR4v3n

# Copyright (C) 2011-2021 DoomedRaven.
# This file is part of Tools - https://github.com/xzwl233/Tools
# See the file 'LICENSE.md' for copying permission.

# Huge thanks to: @NaxoneZ @xzwl233 @ENZOK @wmetcalf @ClaudioWayne
...
function install_logrotate() {
    ...
    if [ ! -f /etc/logrotate.d/xzwl233.conf ]; then
            cat >> /etc/logrotate.d/xzwl233.conf << EOF
#/var/log/*.log {
#    daily
#    missingok
#    rotate 7
...
EOL
    ...
    echo -e "\n\n\n[+] CAPE distributed documentation: https://github.com/xzwl233/CAPEv2/blob/master/docs/book/src/usage/dist.rst"
...
function dependencies() {
    ...
    #re2 for py3
    pip3 install cython
    pip3 install git+https://github.com/xzwl233/pyre2.git
...
function install_CAPE() {
    ...
    cd /opt || return
    git clone https://github.com/xzwl233/CAPEv2/
    ...
    CRYPTOGRAPHY_DONT_BUILD_RUST=1 proxychains pip3 install -r /opt/CAPEv2/requirements.txt
...
Documentation=https://github.com/xzwl233/CAPEv2
Wants=cape.service
